...
require_once('model/Login/Session.php');
...
<head>
  ...
  <!-- <li class="nav-item">
    <a class="nav-link disabled" href="../../view/userManagement/add_user.php" tabindex="-1" aria-disabled="true">Disabled</a>
  </li> -->
  <?php
}
 else 
...
<div class="loggedin">You Are Logged In As <?php echo $_SESSION['username']; ?> |  <a href="/HospitalDonation/view/loginSystem/logout.php">Log out</a></div>
</header>
